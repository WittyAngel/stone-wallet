...
class CreateNewWalletPage4 extends StatefulWidget {
  ...
  const CreateNewWalletPage4({required this.seed,Key? key}) : super(key: key);
                ...
                Container(
                  ...
                  child: Column(
                    children: [
                      ...
                      Text(
                        'Please select your ${random!+1}th seed word',
                      ...
                      mixed_seeds == null ? Container() : Container(
                        height: height*0.55,
                        width: width*0.95,
                        child:
                        GridView.count(
                              ...
                              return GestureDetector(
                                child: Container(
                                  ...
                                  child: Text(
                                    mixed_seeds![index],
                                    style: TextStyle(
                                      color: !isTaped![index]? Colors.white : Colors.black87,
